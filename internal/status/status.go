...
func (s *Status) WithDetails(details ...protoiface.MessageV1) (*Status, error) {
	if s.Code() == codes.OK {
	...
	for _, detail := range details {
		// Convert v1 message to a v2 message.
		any, err := anypb.New(protocompat.MessageV2(detail))
		if err != nil {
			return nil, err
		}
...
func (s *Status) Details() []interface{} {
	...
	for _, any := range s.s.Details {
		if detail, err := any.UnmarshalNew(); err != nil {
